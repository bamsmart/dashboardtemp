	...
	<section class="content-header">
		<h1>
			Form Reservasi <!-- <small>Preview</small> -->
		</h1>
		<ol class="breadcrumb">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Jenis Pengujian: </label> <select class="form-control select2"
								...
								style="width: 100%;">
								<option>Pengujian Pemeriksaaan dan Dimensi Sudut Kusut Kain</option>
								<option>Pengujian Tetal Benang dan Anyaman Kain</option>
								<option>Pengujian Nomor Benang</option>
								<option>Pengujian Kekuatan Tarik</option>
								<option>Pengujian Kekuatan Sobek (Elmendorf)</option>
								<option>Pengujian Daya Tembus Udara</option>
								<option>Pengujian Kain Twist</option>
							</select>
						</div>
						<!-- /.form-group -->
						<div class="form-group">
